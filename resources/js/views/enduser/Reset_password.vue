  ...
  <div class="enduser">
        <div class="overlay">
            <div class="box">
                ...
                <p class="box-p">recover your password now</p>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <button @click="resetPassword()" class="btn btn-lg btn-block btn-primary">reset password</button>
                </div>
            </div>
        </div>
  </div>
...
export default {
  ...
  methods:{
    async resetPassword(){
      ...
      axios({url: '/auth/reset_password/'+ this.$route.params.token ,method: 'post', data: fd})
      .then(res=> {
