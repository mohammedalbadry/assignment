...
export default {
    ...
    methods:{
      gettimetable(){
          axios({ url: '/timetables/'+ this.$route.params.id, method: 'get' })
            .then(response=> {
                this.form = response.data.data
                this.getuser(response.data.data.user_id)
                this.getphamacy(response.data.data.pharmacy_id)
            })
        ...
        async update (){
            ...
            axios({url: 'timetables/'+ this.$route.params.id, method: 'post', data: fd})
            .then(response=> {
